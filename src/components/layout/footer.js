...
const Footer = props => (
  <footer className = 'fixed bottom-0 w-full p-2 ml-[6rem]'>
    ...
    <h1 className = 'text-center'>With <span className='text-red-500'>❤</span> from <a href = 'https://sliitfoss.org/' target = '_blank' className='text-blue-primary'>SLIIT FOSS</a></h1>
  </footer>
);
